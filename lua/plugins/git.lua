    ...
    -- git decoration to the left
    {
        ...
        after = function()
            ...
            hi.onColorScheme(function()
                ...
                hi.set("GitSignsAddNr", { fg = linenr, bg = hi.bg("DiffAdd") })
                hi.set("GitSignsStagedAddNr", { fg = linenr, bg = hi.fg("GitSignsStagedAdd") })
                hi.set("GitSignsChangeNr", { fg = linenr, bg = hi.bg("DiffChange") })
                hi.set("GitSignsStagedChangeNr", { fg = linenr, bg = hi.fg("GitSignsStagedChange") })
                hi.set("GitSignsChangedeleteNr", { fg = linenr, bg = hi.bg("DiffChange"), underline = true, special = delete })
                hi.set("GitSignsStagedChangedeleteNr",
                    { fg = linenr, bg = hi.fg("GitSignsStagedChangedelete"), underline = true, special = stageddelete })
