...
class AlignmentWriter(interfaces.AlignmentWriter):
    ...
    def __init__(self, target, bedN: int = 12, declaration=None, targets=None, compress: bool = True, itemsPerSlot: int = 512, blockSize: int = 256, extraIndex=()) -> None: ...
...
class AlignmentIterator(interfaces.AlignmentIterator):
    ...
    def search(self, chromosome=None, start=None, end=None) -> Generator[Incomplete]: ...
