...
from Bio.Seq import MutableSeq as MutableSeq, Seq as Seq, SequenceDataAbstractBaseClass as SequenceDataAbstractBaseClass, UndefinedSequenceError as UndefinedSequenceError, reverse_complement as reverse_complement, translate as translate
...
class MultipleSeqAlignment:
    ...
    def __init__(self, records, alphabet=None, annotations=None, column_annotations=None) -> None: ...
...
class Alignment:
    ...
    @classmethod
    def from_alignments_with_same_reference(cls, alignments: list['Alignment'] | tuple['Alignment']) -> Alignment: ...
    sequences: Incomplete
    coordinates: Incomplete
    def __init__(self, sequences, coordinates=None) -> None: ...
...
class PairwiseAligner(_pairwisealigner.PairwiseAligner):
    ...
    def __init__(self, scoring=None, **kwargs) -> None: ...
...
class CodonAligner(_codonaligner.CodonAligner):
    ...
    def __init__(self, codon_table=None, anchor_len: int = 10) -> None: ...
