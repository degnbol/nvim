...
class SeqFeature:
    ...
    def __init__(self, location=None, type: str = '', id: str = '<unknown id>', qualifiers=None, sub_features=None) -> None: ...
    def __eq__(self, other): ...
    def extract(self, parent_sequence, references=None): ...
    def translate(self, parent_sequence, table: str = 'Standard', start_offset=None, stop_symbol: str = '*', to_stop: bool = False, cds=None, gap=None): ...
...
class Location(ABC, metaclass=abc.ABCMeta):
    @staticmethod
    def fromstring(text, length=None, circular: bool = False, stranded: bool = True): ...

class SimpleLocation(Location):
    strand: Incomplete
    ref: Incomplete
    ref_db: Incomplete
    def __init__(self, start, end, strand=None, ref=None, ref_db=None) -> None: ...
    @staticmethod
    def fromstring(text, length=None, circular: bool = False): ...
