...
def build(pro_align, nucl_seqs, corr_dict=None, gap_char: str = '-', unknown: str = 'X', codon_table=None, complete_protein: bool = False, anchor_len: int = 10, max_score: int = 10): ...
