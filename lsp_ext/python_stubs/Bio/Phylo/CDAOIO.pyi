...
class Parser:
    ...
    def parse_handle_to_graph(self, rooted: bool = False, parse_format: str = 'turtle', context=None, **kwargs): ...
    def parse_graph(self, graph=None, context=None) -> Generator[Incomplete]: ...
    def new_clade(self, node): ...
    obj_info: Incomplete
    nodes: Incomplete
    tree_roots: Incomplete
    def get_node_info(self, graph, context=None) -> None: ...
...
class Writer:
    ...
    def process_clade(self, clade, parent=None, root: bool = False) -> Generator[Incomplete, Incomplete, Incomplete]: ...
