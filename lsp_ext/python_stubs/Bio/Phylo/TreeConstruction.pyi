...
class _Matrix:
    names: Incomplete
    matrix: Incomplete
    def __init__(self, names, matrix=None) -> None: ...
    def __getitem__(self, item): ...
    def __setitem__(self, item, value) -> None: ...
    def __delitem__(self, item) -> None: ...
    def insert(self, name, value, index=None) -> None: ...
...
class DistanceCalculator:
    ...
    def __init__(self, model: str = 'identity', skip_letters=None) -> None: ...
...
class DistanceTreeConstructor(TreeConstructor):
    ...
    method: Incomplete
    def __init__(self, distance_calculator=None, method: str = 'nj') -> None: ...
...
class ParsimonyTreeConstructor(TreeConstructor):
    ...
    def __init__(self, searcher, starting_tree=None) -> None: ...
