...
class Writer:
    ...
    def to_strings(self, confidence_as_branch_length: bool = False, branch_length_only: bool = False, plain: bool = False, plain_newick: bool = True, ladderize=None, max_confidence: float = 1.0, format_confidence: str = '%1.2f', format_branch_length: str = '%1.5f') -> Generator[Incomplete, None, Incomplete]: ...
