...
class _SeqAbstractBaseClass(ABC, metaclass=abc.ABCMeta):
    ...
    def split(self, sep=None, maxsplit: int = -1): ...
    def rsplit(self, sep=None, maxsplit: int = -1): ...
    def strip(self, chars=None, inplace: bool = False): ...
    def lstrip(self, chars=None, inplace: bool = False): ...
    def rstrip(self, chars=None, inplace: bool = False): ...
...
def translate(sequence, table: str = 'Standard', stop_symbol: str = '*', to_stop: bool = False, cds: bool = False, gap=None): ...
