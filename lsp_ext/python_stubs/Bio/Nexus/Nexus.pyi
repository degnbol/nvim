...
class Nexus:
    ...
    def write_nexus_data_partitions(self, matrix=None, filename=None, blocksize=None, interleave: bool = False, exclude=(), delete=(), charpartition=None, comment: str = '', mrbayes: bool = False): ...
    def write_nexus_data(self, filename=None, matrix=None, exclude=(), delete=(), blocksize=None, interleave: bool = False, interleave_by_partition: bool = False, comment=None, omit_NEXUS: bool = False, append_sets: bool = True, mrbayes: bool = False, codons_block: bool = True): ...
    def append_sets(self, exclude=(), delete=(), mrbayes: bool = False, include_codons: bool = True, codons_only: bool = False): ...
    def export_fasta(self, filename=None, width: int = 70): ...
    ...
    def terminal_gap_to_missing(self, missing=None, skip_n: bool = True) -> None: ...
