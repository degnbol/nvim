...
class BgzfReader:
    ...
    def __init__(self, filename=None, mode: str = 'r', fileobj=None, max_cache: int = 100) -> None: ...
    def tell(self): ...
...
class BgzfWriter:
    ...
    def __init__(self, filename=None, mode: str = 'w', fileobj=None, compresslevel: int = 6) -> None: ...
