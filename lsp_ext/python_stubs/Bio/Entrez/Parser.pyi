...
class ListElement(list):
    ...
    def __init__(self, tag, attributes, allowed_tags, key=None) -> None: ...
...
class DictionaryElement(dict):
    ...
    def __init__(self, tag, attrs, allowed_tags, repeated_tags=None, key=None) -> None: ...
    def store(self, value) -> None: ...
...
class OrderedListElement(list):
    ...
    def __init__(self, tag, attributes, allowed_tags, first_tag, key=None) -> None: ...
    def store(self, value) -> None: ...
...
class DataHandler(metaclass=DataHandlerMeta):
    ...
    def verify_security(self, url, verify_hostname: bool = True) -> None: ...
