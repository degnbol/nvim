...
class Op:
    ...
    is_hkl: ClassVar[nanobind.nb_method] = ...
    as_hkl: ClassVar[nanobind.nb_method] = ...
    as_xyz: ClassVar[nanobind.nb_method] = ...
...
class UnitCell:
    ...
    find_nearest_pbc_images: ClassVar[nanobind.nb_method] = ...
    find_nearest_pbc_position: ClassVar[nanobind.nb_method] = ...
    fract_image: ClassVar[nanobind.nb_method] = ...
...
class IT92Coef:
    ...
    precalculate_density_iso: ClassVar[nanobind.nb_method] = ...
    @property
    def a(self): ...
    @property
    def b(self): ...
...
class ExpSum5:
    ...
    calculate_with_derivative: ClassVar[nanobind.nb_method] = ...
it92_radius_approx: nanobind.nb_func
determine_cutoff_radius: nanobind.nb_func
...
class C4322Coef:
    ...
    @property
    def b(self): ...
set_custom_form_factors: nanobind.nb_func
...
class CRA:
    ...
    cid: ClassVar[nanobind.nb_method] = ...
    chain: Incomplete
    residue: Incomplete
    atom: Incomplete
...
class Structure:
    ...
    set_deuterium_fraction_of_hydrogens: ClassVar[nanobind.nb_method] = ...
    ...
    add_microhetero_to_sequences: ClassVar[nanobind.nb_method] = ...
    clone: ClassVar[nanobind.nb_method] = ...
...
class FlatStructure:
    __new__: ClassVar[builtin_function_or_method] = ...
    __init__: ClassVar[nanobind.nb_method] = ...
    generate_structure: ClassVar[nanobind.nb_method] = ...
    leave_only: ClassVar[nanobind.nb_method] = ...
    __len__: ClassVar[nanobind.nb_method] = ...
    strings_as_numbers: Incomplete
    @property
    def b_iso(self): ...
    @property
    def occ(self): ...
...
path_in_pdb_dir: nanobind.nb_func
...
class FloatGrid(FloatGridBase):
    ...
    interpolate_grid_flexible: ClassVar[nanobind.nb_method] = ...
...
class SolventMasker:
    ...
    use_atom_occupancy: Incomplete
interpolate_grid: nanobind.nb_func
interpolate_grid_around_model: nanobind.nb_func
...
class Mtz:
    ...
    write_to_bytes: ClassVar[nanobind.nb_method] = ...
...
class Intensities:
    ...
    merged: ClassVar[nanobind.nb_method] = ...
...
class Hybridization(enum.Enum):
    ...
    _value_repr_: ClassVar[None] = ...
    __nb_enum__: ClassVar[PyCapsule] = ...
    SP1: ClassVar[Hybridization] = ...
    SP2: ClassVar[Hybridization] = ...
    SP3: ClassVar[Hybridization] = ...
    SPD5: ClassVar[Hybridization] = ...
    SPD6: ClassVar[Hybridization] = ...
    SPD7: ClassVar[Hybridization] = ...
    SPD8: ClassVar[Hybridization] = ...
    SP_NON: ClassVar[Hybridization] = ...
    @classmethod
    def __init__(cls, value) -> None: ...

class CoordGeometry(enum.Enum):
    _new_member_: ClassVar[builtin_function_or_method] = ...
    _use_args_: ClassVar[bool] = ...
    _member_names_: ClassVar[list] = ...
    _member_map_: ClassVar[dict] = ...
    ...
    _value_repr_: ClassVar[None] = ...
    __nb_enum__: ClassVar[PyCapsule] = ...
    LINEAR: ClassVar[CoordGeometry] = ...
    TRIGONAL_PLANAR: ClassVar[CoordGeometry] = ...
    T_SHAPED: ClassVar[CoordGeometry] = ...
    TETRAHEDRAL: ClassVar[CoordGeometry] = ...
    SQUARE_PLANAR: ClassVar[CoordGeometry] = ...
    TRIGONAL_BIPYRAMIDAL: ClassVar[CoordGeometry] = ...
    SQUARE_PYRAMIDAL: ClassVar[CoordGeometry] = ...
    OCTAHEDRAL: ClassVar[CoordGeometry] = ...
    TRIGONAL_PRISM: ClassVar[CoordGeometry] = ...
    PENTAGONAL_BIPYRAMIDAL: ClassVar[CoordGeometry] = ...
    CAPPED_OCTAHEDRAL: ClassVar[CoordGeometry] = ...
    SQUARE_ANTIPRISM: ClassVar[CoordGeometry] = ...
    UNKNOWN: ClassVar[CoordGeometry] = ...
    @classmethod
    def __init__(cls, value) -> None: ...
...
class AcedrgTables:
    __new__: ClassVar[builtin_function_or_method] = ...
    __init__: ClassVar[nanobind.nb_method] = ...
    load_tables: ClassVar[nanobind.nb_method] = ...
    tables_loaded: ClassVar[nanobind.nb_method] = ...
    tables_dir: ClassVar[nanobind.nb_method] = ...
    classify_atoms: ClassVar[nanobind.nb_method] = ...
    fill_restraints: ClassVar[nanobind.nb_method] = ...
    fill_bond: ClassVar[nanobind.nb_method] = ...
    fill_angle: ClassVar[nanobind.nb_method] = ...
    compute_acedrg_types: ClassVar[nanobind.nb_method] = ...
    upper_bond_sigma: Incomplete
    lower_bond_sigma: Incomplete
    upper_angle_sigma: Incomplete
    lower_angle_sigma: Incomplete
    min_observations_bond: Incomplete
    min_observations_angle: Incomplete
    min_observations_angle_fallback: Incomplete
hybridization_to_string: nanobind.nb_func
hybridization_from_string: nanobind.nb_func
prepare_chemcomp: nanobind.nb_func
...
make_chemcomp_with_restraints: nanobind.nb_func
...
class ChemCompModel(enum.IntFlag):
    ...
    @classmethod
    def __init__(cls, value) -> None: ...
read_structure_string: nanobind.nb_func
read_structure: nanobind.nb_func
make_structure_from_block: nanobind.nb_func
populate_structure_from_block: nanobind.nb_func
