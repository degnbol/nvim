...
class Clade(BaseTree.Clade):
    ...
    def __init__(self, branch_length: float = 1.0, name: Incomplete | None = None, clades: Incomplete | None = None, confidence: Incomplete | None = None, comment: Incomplete | None = None) -> None: ...
