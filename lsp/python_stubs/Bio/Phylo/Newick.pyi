...
class Clade(BaseTree.Clade):
    comment: Incomplete
    def __init__(self, branch_length: Incomplete | None = None, name: Incomplete | None = None, clades: Incomplete | None = None, confidence: Incomplete | None = None, comment: Incomplete | None = None) -> None: ...
