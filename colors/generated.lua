...
hi(0, "PreProc", { bold = true, fg = "#8577af", italic = true })
hi(0, "Include", { link = "PreProc" })
hi(0, "Special", { fg = "#5a93aa" })
hi(0, "Macro", { fg = "#8eb2af" })
hi(0, "Delimiter", { fg = "#8577af" })
hi(0, "Title", { bold = true, fg = "#e6eaea", underdouble = true })
hi(0, "Bold", { bold = true })
...
hi(0, "@variable.builtin", { italic = true })
...
hi(0, "@constructor.lua", { fg = "#8eb2af" })
