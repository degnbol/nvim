...
hi(0, "@lsp.type.heading.typst", { link = "Title" })
hi(0, "@lsp.type.number.typst", { link = "@number" })
hi(0, "qfSeparatorLeft", { fg = "#152528" })
hi(0, "qfSeparatorRight", { fg = "#152528" })
hi(0, "qfFileName", { link = "@string.special.path" })
hi(0, "qfLineNr", { link = "LineNr" })
hi(0, "qfError", { link = "DiagnosticError" })
hi(0, "qfWarning", { link = "DiagnosticWarn" })
hi(0, "qfInfo", { link = "DiagnosticInfo" })
hi(0, "qfNote", { link = "DiagnosticHint" })
hi(0, "csvCol1", {})
hi(0, "csvCol2", {})
hi(0, "csvCol3", {})
hi(0, "csvCol4", {})
