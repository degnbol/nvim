...
hi(0, "NormalFloat", { bg = "#09191C", fg = "#e6eaea" })
...
hi(0, "StatusLine", { fg = "#000000" })
hi(0, "StatusLineNC", { fg = "#000000" })
hi(0, "TabLine", { bg = "#1D3033", fg = "gray" })
hi(0, "TabLineFill", { bg = "#09191C", fg = "gray" })
...
hi(0, "@punctuation.special.prompt", { link = "Prompt" })
